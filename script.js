...
function createParticle(x, y) {
    ...
    particle.style.boxShadow = '0 0 5px rgba(255, 255, 255, 0.8), 0 0 10px rgba(255, 255, 255, 0.6), 0 0 15px rgba(255, 255, 255, 0.4)';
    ...
    function animate(time) {
        ...
        particle.style.transform = `translateY(${progress * 100}px) scale(${1 - progress})`;
